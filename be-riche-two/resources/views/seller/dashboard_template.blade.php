...
<body >
    <div class="flex h-screen w-full bg-gray-800 " x-data="{openMenu:1}">
        ...
        <div class="flex flex-col bg-gray-200 h-screen w-16">
          ...
          <a href="{{ route('sellerdashboard') }}" class="flex items-center justify-center h-16 hover:bg-gray-300">
              <i class="fas fa-chart-bar text-gray-700"></i>
          </a>
          <a href="{{ route('addproduct') }}" class="flex items-center justify-center h-16 hover:bg-gray-300">
